...
function TooltipCpt(props: { text: string; className?: string }) {
  return (
    <div
      className={
        "pointer-events-none select-none rounded bg-neutral bg-opacity-90 px-1.5 py-1 text-xs font-thin text-neutral-content shadow" +
    ...
    <Disclosure>
      {({ open }) => (
        <div className="relative flex flex-col justify-end p-2.5">
          ...
          <Disclosure.Panel
            className="absolute left-full ml-1 select-none rounded
            bg-neutral bg-opacity-90 fill-neutral-content text-xs font-thin text-neutral-content shadow transition-all
            duration-300 ease-in-out hover:bg-neutral-focus"
          >
